...
public class InternetAdvertisementsTest {
    ...
    private static Instance[] initializeInstances() {
        ...
        double[][][] attributes = new double[3279][][];

        try {
            BufferedReader br = new BufferedReader(new FileReader(new File("src/opt/test/ad_missing_values_replaced.txt")));
            ...
            for(int i = 0; i < attributes.length; i++) {
                ...
                attributes[i][0] = new double[1558]; // 1558 attributes
